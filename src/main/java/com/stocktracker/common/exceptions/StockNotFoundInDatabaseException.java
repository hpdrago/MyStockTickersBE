...
public class StockNotFoundInDatabaseException extends RuntimeException
{
    public StockNotFoundInDatabaseException( final String tickerSymbol )
    {
    ...
    public StockNotFoundInDatabaseException( final String tickerSymbol, final IOException e )
    {
