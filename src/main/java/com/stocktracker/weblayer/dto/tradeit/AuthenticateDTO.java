...
{
    private List<LinkedAccountDTO> linkedAccountDTOs;
    ...
    {
        this.linkedAccountDTOs = linkedAccountDTOs;
    }
     ...
     * @return
     */
    public List<LinkedAccountDTO> getLinkedAccountDTOs()
    {
    ...
    public String toString()
    {
        ...
        sb.append( "linkedAccountDTOs=" ).append( linkedAccountDTOs );
